...
from Am.Plugins.ping import get_readable_time
from Am.Database import remind_sql as sql
...
def clearallreminders(update: Update, context: CallbackContext):
    ...
    if chat.type != "private" and member.status != "creator" and member.user.id not in INSPECTOR:
