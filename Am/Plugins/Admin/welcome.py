...
import Am
import Am.Database.welcome_sql as sql
import Am.Database.global_bans_sql as gban_sql
from Am import (
...
from Am.Handlers.misc import (
    build_keyboard,
    revert_buttons,
)
from Am.Handlers.msg_types import get_welcome_type
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I'll go loaf around and not welcome anAm then.",
            )
